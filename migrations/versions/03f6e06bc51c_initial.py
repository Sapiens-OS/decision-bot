...
Revision ID: 03f6e06bc51c
Revises: 
Create Date: 2026-03-21 20:31:28.042504
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('NEW', 'DECIDED', 'COMPLETED', name='decisionstatus'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
